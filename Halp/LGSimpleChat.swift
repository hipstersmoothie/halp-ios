    ...
    */
    ...
    private func styleTextViewForSentBy(sentBy: LGChatMessage.SentBy) {
        ...
        case .Opponent:
            ...
            self.textView.layer.backgroundColor = Appearance.opponentColor.CGColor
        ...
        case .User:
            ...
            self.textView.center.y = halfTextViewHeight
            self.textView.layer.backgroundColor = Appearance.userColor.CGColor
...
class LGChatController : UIViewController, UITableViewDelegate, UITableViewDataSource, LGChatInputDelegate {
    ...
    */
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        let beginSession = UIBarButtonItem(title: "Begin!", style: .Bordered, target: self, action: "begin")
        self.navigationItem.rightBarButtonItem = beginSession
    }
